...
class Phoenix_VarnishCache_Helper_Control_Blog extends Phoenix_VarnishCache_Helper_Data
{
    const XML_PATH_VARNISH_CACHE_PURGE = 'system/varnishcache/purge_blog';
